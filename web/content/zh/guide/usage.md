...
```
终端 1：bunx oh-my-ag dashboard:web
...
```bash
bunx oh-my-ag                # 交互式技能安装器
bunx oh-my-ag doctor         # 检查设置并修复缺失的技能
bunx oh-my-ag doctor --json  # JSON 输出，适用于 CI/CD
bunx oh-my-ag update         # 将技能更新到最新版本
bunx oh-my-ag stats          # 查看生产力指标
bunx oh-my-ag stats --reset  # 重置指标
bunx oh-my-ag retro          # 会话回顾（经验教训与后续步骤）
bunx oh-my-ag dashboard      # 终端实时仪表盘
bunx oh-my-ag dashboard:web  # Web 仪表盘 (http://localhost:9847)
bunx oh-my-ag help           # 显示帮助
```
