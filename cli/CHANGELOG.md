...
## [5.0.0](https://github.com/h0130jk2-heo/oh-my-agent-ev/compare/cli-v4.22.4...cli-v5.0.0) (2026-04-06)
...
* **action:** add GitHub Action for automated oma update ([dc22007](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/dc220070a1c180d3e32b9c2f00eafb2e5c1888b3))
* add /stack-set workflow and Node.js/Rust presets ([438d5fd](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/438d5fd734bb1d0672616e626f333522a299839f))
* add agent scope violation check to verify command ([339e658](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/339e65846bcebfc4d909ffc1d0e21452d88c0c6c))
* add autoresearch-inspired protocols with full infrastructure compatibility ([84b0c4d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/84b0c4d31e61ef4759ffd13bffc252d1f1e80e81))
* add chrome-devtools MCP server with isolated mode ([bbc162e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bbc162e8a4d3b0858c58813b646ba12308fcaeba))
* add Claude Code hooks for automatic workflow detection ([5f18af3](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/5f18af38ecfe7bf4228d121cda5d491ce9f58788))
* add cross-vendor hook support for Codex CLI and Gemini CLI ([9fc8513](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/9fc85130803bc62cef1725b25a39562ad1714419))
* add deactivation detection, export hooks for testing, detect superpowers ([d3baa71](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/d3baa71f4a4f186b33636b18d299c3ceb3ce1760))
* add i18n response language rules ([4cb69b8](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/4cb69b8ab39dbe9e65207e61c2923acf003e91f8))
* add language variant selection to CLI install/update ([a62f81d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/a62f81dd83061c62f2eb94491968328d18bd9ce8))
* add OMA HUD statusline for Claude Code ([6f4cbf8](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/6f4cbf8c8d3c7bf43673f88eb194a2f697116a57))
* add oma-design skill with DESIGN.md workflow and anti-pattern system ([4f7a897](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/4f7a8971c1ecd59509acbfa117d5f8818a421b3b))
* add oma-evaluator extension on top of oh-my-agent ([392492e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/392492e887429c6b588027bff730c7ddd36dd0f6))
* add oma-ralph persistent self-referential execution loop ([cf42146](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/cf42146c1a51ce4b8ffef903a17824517ea8c8c7))
* add Qwen Code hook support ([2670f1d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/2670f1d67ebab627d779426041ca44781a01a18c))
* add rules installation to CLI install/update pipeline ([c9ae3fc](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/c9ae3fcde48eabb9f43c31890dd0e817e4b78b5f))
* add vendor adaptation infrastructure ([d7ab84d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/d7ab84d2c75234982f761bd512cb88df92aeafcb))
* **agents:** reinforce harness design based on Anthropic research ([b0920bb](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b0920bbc98d26419342dc58c172e854211770d0d))
* auto-enable codex_hooks feature flag on oma install ([fd94cb6](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/fd94cb65a143a91255f8e68d63f7ccccb19fb030))
* auto-register Serena project during install and update ([b868047](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b868047878d2b95b8b77ab2988ae0983b2df69a7))
* autoresearch-inspired protocols v2 (infrastructure-compatible) ([2bc9b9c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/2bc9b9cf6fdb5a817b41652309f88fdd993f15f4))
* **claude:** add native Claude Code adapter layer with skills, agents, and orchestration loops ([2a2cce0](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/2a2cce095423e8a58aec0495f74db7cf2f605da8))
* **cli:** add agent:review command and rename -v to -m flag ([1b48055](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/1b480555eca21e60aa19f26ab066fc1f208ba589))
* **cli:** add auth:status command and integrate auth checks into doctor ([cdeaf53](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/cdeaf53675ba83b9e68bda83443ebc5fe434357a))
* **cli:** add DevOps preset to install wizard ([e428529](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/e428529010aca69be8d08796afc7b328d747042d))
* **cli:** add explicit install command and auto-redirect from update ([477eeb3](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/477eeb384af94900decb10cf4453340d5449c666))
* **cli:** add recommended Claude Code settings and user-level CLAUDE.md ([3f41e35](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/3f41e35963fc4e6c065fba84793409f0ea7bd0e6))
* **cli:** add visualize command for dependency graph ([e8ea4aa](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/e8ea4aa2142675485460bd5f5ee9cbb8337174ee))
* **cli:** auto-create .claude/skills/ symlinks without prompting ([05e24d3](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/05e24d3f0d80c1bd209bd3c803e2f950d10c64bb))
* **cli:** auto-install codex-plugin-cc when both Claude and Codex are detected ([71ef5a0](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/71ef5a0ff42184b038eac861fa073cb432981a2d))
* **cli:** enhance retro command with rich metrics, time windows, and compare mode ([ad901aa](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/ad901aad4e9d158e9ae7ce74e348ce27eedd1399))
* **cli:** install Claude Code native skills and agents on install/update ([2fd5627](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/2fd562760e8a3a1ac8b1f1cb3b5f23a86193792e))
* **cli:** preserve user-customized config files during update ([bb80216](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bb802168834343b5bc108601ef39edcc83d9d322))
* **cli:** prompt star on install and update if not yet starred ([acecd71](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/acecd7174f3c246b021a217d78bee1f4707cccca))
* **cli:** restore Claude Code and GitHub Copilot symlink prompt during install ([db93945](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/db93945aa337dae1874ca7de91831720ee4f95b8))
* **cli:** show contextual support message based on star status ([42d7b19](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/42d7b198bc1519ef523d7fa4a1d1d9d7e95497fb))
* **cli:** sync CLI version from package.json and auto-bump Homebrew formula ([de179a1](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/de179a149e58b1c43476f4f394322ea5992f9211))
* detect and offer to remove competing oh-my-* tools on install/update ([bfc0118](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bfc0118654fe896bb90e9516a9e00917f5b604ae))
* dynamically scan available languages from docs/README.*.md ([f4d419c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/f4d419c017428e592087b3ce0f7de4b912a26bfb))
* enhance oma-translator with Europeanized patterns and refined mode ([074c63c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/074c63cbc8ca6baed6f4b7314b2e1cc75240c23b))
* **hooks:** fix informational filter, expand keywords, add extension-based agent routing ([7881f4d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/7881f4d5571414f0234e757cb927e73ae4e48a4c))
* include built cli.js for Node.js users without bun ([#4](https://github.com/h0130jk2-heo/oh-my-agent-ev/issues/4)) ([b97b2e6](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b97b2e669ef2fafbd5d7cb304429238599ebe14e))
* integrate evaluator into orchestrate, coordinate, ultrawork, plan ([#1](https://github.com/h0130jk2-heo/oh-my-agent-ev/issues/1)) ([5d3c2c8](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/5d3c2c8b85d82e3ed378764eed4f8eb1007ace5b))
* **plugin:** add Claude Code plugin manifest and marketplace ([91d9c1b](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/91d9c1ba0db9e9ad6af5f2651dcb8d36f227fb93))
* prompt language selection during oma install ([b706646](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b706646022f11a21c1567a1079dc7f107c1c8a41))
* **qa:** add Chrome DevTools MCP isolated runtime verification and skeptical evaluator posture ([10c4dba](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/10c4dba079da80898b6af179e05c6c561fb712a9))
* rebrand fork — heo-agent, point REPO to own repo, add fork notice to README ([#3](https://github.com/h0130jk2-heo/oh-my-agent-ev/issues/3)) ([8b6b7f0](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8b6b7f04ffb4392d0337d31af1bdf6c109aa37db))
* **skills:** add 12-Factor cloud readiness rules to oma-backend ([4d3ac32](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/4d3ac328eef01c8af7eb5eed8416cf2a04502cab))
* **skills:** add db-agent with vector retrieval guidance ([f433c18](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/f433c184efa72f95c49ce8616ead7fad9b1be6eb))
* **skills:** add ISO guidance across core agents ([58ce1af](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/58ce1afe7e6b663210c0a9ea5b888db67419daa7))
* **skills:** add translator skill with anti-AI pattern detection ([1c62625](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/1c62625c24eae78b12d839dcc5284421a956c820))


### Bug Fixes

* add plugin hooks.json and tighten orchestrate triggers ([9760f1a](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/9760f1a354d76eeecd2e3d53ecb86b38bef4038b))
* address code review findings ([e395bce](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/e395bce6ac3434f493eff0a912b5cfcdc57aba53))
* address reviewer feedback — inject Execution Protocol, remove deprecated calls ([848dca0](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/848dca03d3bb2f9d2b26233cbf67d6e1b840eb49))
* address reviewer feedback on PR [#123](https://github.com/h0130jk2-heo/oh-my-agent-ev/issues/123) ([bd1ba25](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bd1ba2570b43367c447ab08766c765b80aabd1ce))
* align marketplace plugin name with plugin.json ([f82f871](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/f82f8715042cf29dc0ef8990607085d06b37af77))
* **ci:** add pull --rebase before push in sync-manifest workflow ([ebae49b](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/ebae49b3e66fa3db382da318bbad45d5da3c7017))
* **ci:** extract homebrew bump to manual workflow and update formula ([7e57bac](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/7e57bac22a808bb184a52c273c837a6973bd2362))
* **ci:** prevent release-please race with sync-manifest workflow ([9135cee](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/9135cee38d4b00c14f21b89a6562894b74303d39))
* **cli:** ensure ~/.claude directory exists before writing CLAUDE.md in CI ([0f1b5b8](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/0f1b5b83cc69f1287f0785ebab749206d8aa64c7))
* **cli:** handle existing symlinks during reinstallation ([adf43a2](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/adf43a29b640e171307fe0942f0e4ecd5dea405a))
* **cli:** improve agent stability and Claude Code integration ([17655fb](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/17655fbc604513d0e6b0d87bdadadc2507b418ad))
* **cli:** inline omc uninstall to avoid ETIMEDOUT from curl|bash ([955eef5](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/955eef533b81e4dfa2be493d6eaca493d0dab66d))
* **cli:** preserve oma skill routers when removing omc skills ([91fa766](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/91fa76651441581c74ae4aa0acd1a3c7724fec9e))
* **cli:** remove skill symlinks from repo to fix update error ([be16d10](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/be16d10bb705dfa0d49f9dbc7e75fd3b53e8ecf9))
* **cli:** separate update flow from install ([7bf8bf9](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/7bf8bf9f30959e32166edeba51ac9adf8139c3e8))
* **cli:** sync npm readme from root ([1a6112f](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/1a6112fd3ca31fd360bc8fa9beb5d719f26ba1b9))
* **cli:** use codex --version instead of which for cross-platform detection ([a637add](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/a637add7ae61f8dd32fccfaed4b6c54bd5a6b983))
* close Simple fast-track verification gaps found via agent testing ([dade64b](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/dade64bf63d5430b27584bed3daa6efcb7b3abc2))
* correct Gemini deny decision and Codex hook paths ([76e1de5](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/76e1de55ce13793fe95b44865018e706041595f3))
* correct preset tables, auth commands, and shared layout migration ([27d6bb0](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/27d6bb04ccd19d3b7d5fca327ced4bddaa9abcfa))
* **demo:** use Hack Nerd Font for VHS recording ([b16bdd7](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b16bdd711e38ba4c58bca589926d8d5488480839))
* detect active competitor installs instead of leftover directories ([a437845](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/a43784573c1b8e4e8ab05a051a07813177601122))
* detect legacy files before cpSync in update migration ([b88c7f4](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b88c7f4713b27d7b57a4386322ad7d4a2dc540c2))
* **docs:** escape pipe character in curl command for proper markdown table rendering ([4c47f4d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/4c47f4dbe2dd9c098d212d064ad4c9373486bb68))
* **docs:** improve all 10 README translations with anti-AI patterns ([bef08a5](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bef08a5a77bd547b04f144c7a94548fe9812ac30))
* enforce auth boundary in frontend agent to prevent direct DB access ([c0c83dd](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/c0c83dd51305cc1af48fa296011a07fcfc2c81fd))
* force-remove .agent/ after merge and add migrateToAgents tests ([9dbd6cc](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/9dbd6cc24cbc3c28c7d463308a7bec5b510e3753))
* harden installer bootstrap ([3c214f3](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/3c214f3644f236ccbd3d982dd9ca3899853e1d97))
* harden parseFrontmatter against inline --- and malformed YAML ([d51c05d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/d51c05d2b48bf1946d3d0e21e498d5fee84252ab))
* **hooks:** prevent false positive workflow activation on meta-discussion ([771d309](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/771d3099988f856afc1e2db420c2ad4607e8913f))
* **hooks:** remove yaml dependency from keyword-detector hook ([a6a7a7b](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/a6a7a7b0503121f411d8ee2ef05cf684d732ab08))
* **hooks:** resolve CLAUDE_PROJECT_DIR to git root to prevent subdirectory state file misplacement ([96c381c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/96c381c392774cf82daf1477ac251d3ed00b1691))
* install hooks for all 3 vendors on oma install/update ([1d8f8d1](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/1d8f8d1cba1ecf9054cc910f11957ec8239c8af4))
* read migration variant from repoDir and move variants/ cleanup after migration ([8f16788](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8f16788b05a257c23110e6e44e57bb3c5f0d51bc))
* redirect stdin from /dev/tty for interactive CLI in pipe install ([4019f59](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/4019f5973a046957c7b835820a47350e4327f7fd))
* reduce false positives in keyword-detector and improve persistent mode deactivation ([8f1cd67](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8f1cd679d770b1be46e5ec2b56633b43477f0657))
* regenerate .claude/agents with correct runtime/ execution protocol path ([bc286e6](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bc286e6f40b91a2eee7e957c9fe9f53aa5a7f57e))
* remove chore type from changelog sections ([7098d92](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/7098d92d3d472c4abfb7320c7d998895e0e5bd33))
* remove evaluator auto-spawn from core workflows ([#2](https://github.com/h0130jk2-heo/oh-my-agent-ev/issues/2)) ([0723f74](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/0723f741fad897b9b9e7edad42c1d48c36e7ed8f))
* remove hardcoded Korean text from i18n guide ([8f69034](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8f690341fd9ec0bbf9931e94d518c3353402a502))
* remove slash from marketplace plugin name ([8ea9616](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8ea9616b6420405e797bb477ac4509ae740506d0))
* remove slash from marketplace plugin name ([686250c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/686250ccc9888a9dc77e09a65f1d22a7ef04b650))
* remove slash from marketplace plugin name ([15b1d0e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/15b1d0e5898e820ee7df2e00335617411469e1e8))
* rename oh-my-ag display name to oh-my-agent and use oma alias in demos ([bd96bcb](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bd96bcb71669b29a5bd9722819887eb237fd7992))
* replace dead oh-my-agent.dev URL with GitHub Pages link ([bdcaf6e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bdcaf6efa25483ed4cfe291745d2351aa7987dec))
* rewrite i18n guide in English and align frontmatter format ([fbe5a8f](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/fbe5a8f661abf12ea7aad4d3bac565a062ae9730))
* simplify parseFrontmatter offset and anchor resultName regex ([7a7e6bc](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/7a7e6bcd62ca9368340d45298cc81a32aaa92021))
* **skills:** update outdated stack versions in oma-pm ([08d56b1](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/08d56b1a8c6290bc1896091b7358f56475048d42))
* strengthen oma-translator skill wording and coverage ([aa2a527](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/aa2a527e390b7eb0bf16d492aefe862f6715ac4f))
* **test:** use dynamic version comparison in metadata test ([3ce8fbf](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/3ce8fbf68951be7e7bdd634ecb37478130c9b19d))
* update workflow count to 13, fix commit mapping, clarify skill-routing stage 2 ([1d515d4](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/1d515d44d6a36e478d93e0c34eeb51dd88b000a4))
* use session-scoped naming for state and result files ([ff8e5b7](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/ff8e5b79add74c299b6b0bff8d9b73141ed79688))
* use withFileTypes, clearNonDirectory, scope Codex/Gemini docs as planned ([3ccd1c5](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/3ccd1c5f4371f7751f79fbde0dacab890a4c9a6d))
* wire up installVendorAdaptations and fix YAML escaping ([dc43298](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/dc43298213edac608412a4b561698a60584d1ba4))


### Performance

* **cli:** replace individual file downloads with tarball extraction ([f1a1927](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/f1a19273888bfcaa821ef59d754621ec4f2f3606))


### Refactoring

* abstract oma-backend skill to be language-agnostic ([efe842e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/efe842e4ecf9eedaab97454c8de02678fe371a83))
* abstract oma-backend to language-agnostic skill ([a3bdb1c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/a3bdb1ccd81eadf0118aed4aa21794ddfff0cfe9))
* add HUD to CLAUDE.md template, deduplicate settings merge ([8b812de](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8b812def8b033ee709976957c9523aad103e27ef))
* **claude-skills:** make all skills self-contained, remove Required Reading indirection ([ef3868d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/ef3868d85e529071ab221e8ea53df9791c8ee4c1))
* **cli:** remove image export from visualize command ([a3b313c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/a3b313c98b43b038090cc8c879126f2ad523e799))
* **cli:** remove non-null assertions and fix lint issues ([0c76aa4](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/0c76aa4f000718789fc0b39aea0d8df8dff6a652))
* convert .claude/skills/ to thin routers and mark agents as derivatives ([3481a90](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/3481a903bdc6603548348d00d74af44387766684))
* extract abstract agent definitions to .agents/agents/ ([e8cd4b3](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/e8cd4b35c6d6e117951a16ae41756167814a86ea))
* move Execution Protocol to abstract agents with vendor placeholder ([7d3f160](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/7d3f16089cd00cd94b25e05fd98ab67a07856e8f))
* remove .agents/brain/ and consolidate output to .agents/results/ ([3760861](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/37608617a133bd688bfb53ed3757634bd01ecad5))
* remove deprecated /setup workflow replaced by oma install/update ([faf9bae](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/faf9baeac1b922977be547b4825f762e97e312e9))
* rename skills to oma-* prefix and agents to role-based names ([766b1e2](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/766b1e208f8397fd0835803e69b71b9a03a32ce4))
* replace keyword-based auto-activation with explicit skill invocation ([6be9ce7](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/6be9ce7f587e96539edf96cd049dbe274b27eb3c))
* **skill:** rename developer-workflow to dev-workflow ([00b019f](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/00b019fd25da33dcfcd2df54941539e89b7afb1a))
* **skills:** remove hardcoded stack versions from oma-pm ([0f8d14e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/0f8d14eceac7bc9e21e0bfd149271f9444c6687a))
* **skills:** restructure tf-infra-agent to match standard skill pattern ([cf1b8f7](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/cf1b8f7f1b83061296541e20112b2740979933ff))
* **skills:** standardize dev-workflow and translator SKILL.md format ([dee1234](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/dee12349fcaa3bc4e9ab523002bdb4e337f68202))
* unify workflows and agents into .agents/ SSOT ([0195cd8](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/0195cd806cb37aab7f6b15a4e2c4a8fbf3ce571b))
* unify workflows with vendor detection branches ([162e59d](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/162e59dfb0aa54c811919e4bd1a33c485d97aa4b))
* vendor-agnostic execution protocol injection ([61fc225](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/61fc2259ec0c5294db9c994ef266d745e722bbbe))


### Documentation

* add .agents spec and compatibility positioning ([54608d8](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/54608d87abcf95a61e48acc48aeb161253041dea))
* add /oma-translator skill reference to i18n guide ([75db46c](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/75db46cc53abef019ec4455a5fb7501d3a9631fb))
* add Antigravity as first AI IDE in README files ([80b1099](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/80b1099bbf597b5a2506e6e97c1d22b265cb6ab8))
* add benchmark prompt ([fce19ec](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/fce19ec28e681e5bf7cccf2eaf7460bb91e817d1))
* add blank line between badges and language switcher ([4deb9b7](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/4deb9b76351dd151ddaea8ed80043452a93d971d))
* add brew install oh-my-agent as global installation option ([026169e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/026169ef10b451fe72461979b13b778026371c83))
* add design rationale link to Why section across all READMEs ([4ff61d1](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/4ff61d19e937dd083fc599a96a6e123436bed983))
* add dev commands and clarify SSOT rules in CLAUDE.md ([bcddda6](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/bcddda63bfc10d6d3518d5200fd1aa69da8060f8))
* add headers and badges to all README files ([a703c54](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/a703c541dac3c6c1a97adc518ca30843cbe6f809))
* add npm, stars, license, and last-updated badges to all READMEs ([8d799ab](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8d799ab26948635fb0df1bc4fb3e921d9a528fe2))
* add SSOT workflow unification design and task plan ([f354723](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/f3547239c7875b496fec16d205ee65fd2b697eb0))
* add Vietnamese README translation and fix language nav links ([9af8468](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/9af84685ece2ef87aa08f1f3140280bb9f8bb5eb))
* add Vietnamese web content and register vi locale ([53e7fd1](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/53e7fd12e9426963f7b6ec2cee375347bf9e711d))
* **backend-agent:** add ORM guidance ([f9a9339](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/f9a93393dc55c40e88db7d34b32cc2913e88a07e))
* clarify subtitle as 'The Ultimate Agent Orchestrator' ([9de9776](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/9de9776699bde00cb4ba0c05fb12a247db64d556))
* comprehensive documentation rewrite (198 files, 11 languages) ([c97a771](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/c97a7712d61e732fb686b37f79dbb4d51e0febd6))
* comprehensive documentation rewrite across all languages ([d396ce8](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/d396ce808f596d5a2cb3cd8c3fd30500c392c048))
* fill undocumented codebase features in EN/KO web content ([49b5f7e](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/49b5f7e03c3e9fe0ab771a396a0b008522baeb0e))
* fix all README TOC order and remove outdated content ([b759ddc](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b759ddc12fe956760307edc110d565efaa79a2c4))
* fix README.md section order ([2c5af23](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/2c5af233dd1aeb0709376a0af25a6d02112221f3))
* fix README.md TOC and section order ([2fd99a4](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/2fd99a43c43e1e40c950f579e61bb79686b268f1))
* license ([838fb60](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/838fb602da61bfe871f5e9db8fed3afc2f64e734))
* reflect oma-evaluator across all integration points ([b90e9e6](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b90e9e6eaf2b026ac707f26f56b8d5b63e4a6bee))
* remove redundant integration option from README ([05ee5ab](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/05ee5ab177f37e4b16df78d8c7961a06e9e60102))
* remove workflow-guide from README graphs and tables ([22955be](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/22955befc30b9288bc7c1d9e9e2e189133d38cc9))
* reorder all README files to standard structure ([f27f163](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/f27f1632ebf9a39e7b4aa1411a2e1266cbb85b77))
* restore Star History section to all README files ([5871fa5](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/5871fa550a9768e19527cc62a4353c8dae0194c0))
* review and improve translations across all 10 languages ([35eb06b](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/35eb06b95d2252a4b8a653598fab330a9aa87ad1))
* simplify user-facing documentation and standardize structure ([fcbaad7](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/fcbaad7a19b72a002193a0bb325bed10c3b27085))
* **skills:** modernize frontend-agent stack and fix inconsistencies ([b4622a1](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/b4622a1387d7b43f5bb8912a5d87e702d829c497))
* swap Harness/Orchestrator naming (Harness=title, Orchestrator=description) ([6687245](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/6687245d0dc5a063c09ce9674959108e790b7d1e))
* sync localized readmes and remove uk docs ([3808917](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/3808917ced96721766535e7b17fc39436d3fbd36))
* translate 'Agent Orchestrator' in all languages ([25ce948](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/25ce948e08ed38cfa604d4838d17bd154f7e9190))
* translate Chinese README - remove Korean text ([8210f18](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/8210f185a60155723c391327605d49b01435c5a0))
* update compatibility tables and specs for Claude Code native integration ([28f5827](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/28f58279ec9090877212c43da4b72f925c7ef128))
* update docs and README for SSOT unification ([72b7a71](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/72b7a71c13b0903658352e3fc16066e0903acd4d))
* update documentation for backend stack abstraction ([2dc7743](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/2dc77436cbd779f73f5ccaafa9ae243997af0b66))
* update translated README titles and descriptions ([5a10620](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/5a1062055bc9286c2f3e418d22772e38eb65af4d))
* **web:** add missing agents and workflows across all 11 languages ([998924f](https://github.com/h0130jk2-heo/oh-my-agent-ev/commit/998924fb38da8ec59cb93910217c40f149d478b7))
